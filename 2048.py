...
if __name__ == '__main__':
	...
	env = int(input('Enter your environment (Window - 1, Linux - 2) : '))
	...
	while round > 0:
	    ...
	    print()
	    if env == 1:
		    os.system('clear')	# 화면 지우는 부분 - Window
	    else:
		    os.system('clear')	# 화면 지우는 부분 - Linux
	    if moved == 0:
		    print('You should move any block at least once!')
	    maxNumber = maxNum()
